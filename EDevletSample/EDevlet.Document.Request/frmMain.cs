...
namespace EDevlet.Document.Request
{
    public partial class frmMain : Form
    {
        ...
        private void btnCreateDocument_Click(object sender, EventArgs e)
        {
            ...
            {
                var modelRecieved = JsonConvert.DeserializeObject<CreateDocumentModel>(Encoding.UTF8.GetString(ea.Body.ToArray()));
                AddLog($"Received Data Url: {modelRecieved.Url}");
        ...
        void CloseSplashScreen(frmSplash frmSplash)
        {
